...
def decode():
    decoded_TEXT = TEXT.replace('3', 'E')
    decoded_TEXT = decoded_TEXT.replace('4', 'A')
    decoded_TEXT = decoded_TEXT.replace('7', 'T')
    decoded_TEXT = decoded_TEXT.replace('5', 'S')
    decoded_TEXT = decoded_TEXT.replace('1', 'I')
    decoded_TEXT = decoded_TEXT.replace('0', 'O')
